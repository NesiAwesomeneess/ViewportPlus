...
#How to get the mouse position through any node in the subviewport...

onready var scene = get_tree().current_scene #this variable must be included.
func mouse_position(): #call this function when trying to get the mouse position
